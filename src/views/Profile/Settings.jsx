...
import { deleteME, getMe, updatePersonalInformationil, uploadFile } from '../../apis/users';
...
function Settings() {
    ...
    function updateAboutMe() {
        ...
        })).then(res => window.location.href = '/feed')
    }
                            ...
                            <div class="profile__content">
                                ...
                                <form class="profile-form">
                                    <div class="profile-form__grid">
                                        <fieldset class="fg">
                                            <label>Никнейм</label>
                                            <input value={me?.nick} type="text" />
                                        </fieldset>
                                        <fieldset class="fg">
                                            <label>Номер телефона</label>
                                            <input value={me?.phone} type="text" />
                                        </fieldset>
                                        <fieldset class="fg">
                                            <label>Город</label>
                                            <input value={me?.user_information?.city?.value} type="text" />
                                        </fieldset>
                                        <fieldset class="fg">
                                            <label>Язык</label>
                                            <input value={me?.locale} type="text" />
                                        </fieldset>
                                        <fieldset class="fg">
                                            <label>Язык</label>
                                            <input type="text" />
                                        ...
                                        <fieldset class="fg date-field">
                                            ...
                                            <input class="date-input" type="date" value={me?.user_information?.birthday?.value} />
