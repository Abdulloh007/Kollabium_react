                    ...
                    <div class="container">
                        <div class="auth__inner">
                            <div class="auth__top">
                                ...
                                <div class="text24">
                                    На вашу почту отправлена ссылка для подтверждением смены почты
                                </div>
                            </div>
                            <form class="auth-form">
                                <div class="auth-form__grid">
                                    <div class="auth-code">
                                        ...
                                        <div class="auth-code__wrap">
                                            <div class="text24 font2 primary-text">
                                                01:42
                                            </div>
                                            <button class="auth-code__btn">
                                                <span class="text24">повторно отправить код</span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                <div class="auth-form__nav">
                                    <button class="auth-form__btn m-btn m-btn-purple">
