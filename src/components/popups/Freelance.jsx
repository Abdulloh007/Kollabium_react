...
import { closeFreeelanceDialog } from '../../store/dialogs';
import '../css/dialog.css';


function FreelanceDialog(props) {
    const active = useSelector((state) => state.dialog.freelanceActive)
                ...
                <div className="ss_content">
                    ...
                    <div className="ss_text_wrap">
                        <div className="ss_poster">
                            <img src="/svg/pp1.svg" alt="" />
                        </div>
                        <div className="ss_text_wraper">
                            <h4>Данная функция недоступна</h4>
                            <p>Мы активно работаем над этой функцией, она выведена на сайте, что бы вы знали, что на нашем проекта она запланировала в ближайших релизах. Но пока этой функции нет</p>
                            <p className="bold">Ожидайте новых обновлений</p>
                        </div>
                    </div>
                    <button className="ss_act_btn" onClick={() => dispatch(closeFreeelanceDialog())}>Окей</button>
                </div>
            </div>
        </>
    )
...
export default FreelanceDialog;