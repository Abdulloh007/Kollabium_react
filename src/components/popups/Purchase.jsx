...
import { closePurchaseDialog } from '../../store/dialogs';


function PurchaseDialog(props) {
    const active = useSelector((state) => state.dialog.purchaseActive)
        ...
        <>
            <div className={active ? "ss_wrap active": "ss_wrap"}>
                ...
                <div className="ss_content">
                    ...
                    <div className="ss_text_wrap purchase">
                        <div className="ss_poster">
                            <img src="/svg/pp2.svg" alt="" />
                        </div>
                        <div className="ss_text_wraper">
                            <h4>Данная функция недоступна</h4>
                            <p>Это наш маркетплейс товаров, классические маркетплейсы диктуют удушающие условия предпринимателям, меняют правила игры на ходу, мы хотим сделать лояльный, расположенный к своим партнерам маркейтплейс, без удушающих комиссий и глупых правил, с расплатой криптокошельком нашего сервиса, что также позволит быть подальше от бюрократий.</p>
                            <p className="bold">Ожидайте новых обновлений</p>
                        </div>
                    </div>
                    <button className="ss_act_btn" onClick={() => dispatch(closePurchaseDialog())}>Окей</button>
                </div>
            </div>
        </>
    )
