...
import { closeRaitingDialog } from '../../store/dialogs';


function RaitingDialog(props) {
    const active = useSelector((state) => state.dialog.raitingActive)
                ...
                <div className="ss_content">
                    ...
                    <div className="ss_text_wrap">
                        <div className="ss_poster">
                            <img src="/svg/pp3.svg" alt="" />
                        </div>
                        <div className="ss_text_wraper">
                            <h4>Данная функция недоступна</h4>
                            <p>На сервисе много игрофикаций и наград за рейтинги, отличный контент и интересные вещи, созданные пользователями, мы внедряем эту систему, что сейчас находится в разработке.</p>
                            <p className="bold">Ожидайте новых обновлений</p>
                        </div>
                    </div>
                    <button className="ss_act_btn" onClick={() => dispatch(closeRaitingDialog())}>Окей</button>
                </div>
            </div>
        </>
    )
